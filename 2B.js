...
const Currency = require('./structures/economy/GuildCurrency');
...
client.on('error', Logger.error)
    ...
    .once('ready', () => {
        ...
        client.user.setActivity('New Club Features Added!');
        ...
        Club.initializeClubs().then(() => Logger.info('Successfully initialized clubs')).catch(err => Logger.error(err));
    })
    .on('disconnect', () => {
