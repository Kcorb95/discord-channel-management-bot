...
module.exports = class TransferOwnershipCommand extends Command {
    constructor(client) {
        super(client, {
            name: 'transfer-club-ownership',
            aliases: ['transferownership', 'newowner', 'transferclub', 'transfer'],
            group: 'management',
            memberName: 'transfer-club-ownership',
            description: 'Transfer the ownership in a club',
            details: `Transfer the ownership in a club`,
            guildOnly: true,
            args: [
                {
                    key: 'member',
